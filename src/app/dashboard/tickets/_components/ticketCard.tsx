...
interface TicketCardProps {
    ...
    const ticketCardData = [
        {
            ...
            title: "All",
            value: tickets.New+tickets.Open+tickets.Closed,
  ...
  return (
      <div className="w-full grid grid-cols-2 lg:grid-cols-4 justify-between items-start rounded-lg gap-2">
        {ticketCardData.map((data,index) => {
          return (
              <div className={`w-full flex justify-start items-start border border-gray-300 rounded-xl p-2 shadow-md shadow-gray-300 ${data.bgColor}`} key={index}>
