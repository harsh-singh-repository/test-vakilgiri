    ...
    <div className="bg-[#ffffff] p-4 rounded-md">
      ...
      <div className="flex flex-col text-[#091747] text-xs mt-2 gap-y-1">
        ...
        <div className="flex gap-x-1">
          ...
          <span className="font-medium">{data?.businessCin}</span>
        </div>
        <div className="flex gap-x-1">
          <span className="font-bold">DOI:</span>
          <span className="font-medium">{data?.businessRegDate}</span>
        </div>
        <div className="flex gap-x-1">
          <span className="font-bold">PAN:</span>
          <span className="font-medium">{data?.businessPan}</span>
        </div>
        <div className="flex gap-x-1">
          <span className="font-bold">GSTIN:</span>
          <span className="font-medium">{data?.businessGst}</span>
        </div>
        <div className="flex gap-x-1">
          <span className="font-bold">Address:</span>
          <span className="font-medium">{data?.businessAddress1}</span>
        </div>
        <div className="flex gap-x-1">
          <span className="font-bold">Auth Capital:</span>
          <span className="font-medium">{data?.authCapital}</span>
        </div>
        <div className="flex gap-x-1">
          <span className="font-bold">Paidup Capital:</span>
          <span className="font-medium">{data?.paidUpCapital}</span>
        </div>
      ...
      <div className="flex flex-col text-[#091747] text-xs mt-2 gap-y-1">
        ...
        <div className="flex gap-x-1">
          <span className="font-bold">Mobile:</span>
          <span className="font-medium">
            {data?.contactPerson?.mobileNumber}
          </span>
        </div>
        <div className="flex gap-x-1">
          <span className="font-bold">Email:</span>
          <span className="font-medium">{data?.contactPerson?.email}</span>
        </div>
