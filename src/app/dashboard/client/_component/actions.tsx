...
const StackExchangeDialog = (id:any) => {
  ...
  return (
    ...
    <DialogHeader>
      <DialogTitle className='text-[17px] text-[#091747]'>Parag Vadgama</DialogTitle>
    </DialogHeader>
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="discussions">
                <AccordionTrigger className="bg-slate-100 px-4 rounded-lg">
                  Discussions
                </AccordionTrigger>
        ...
        <div className="space-y-2 bg-[#ededed] rounded-md">
          ...
          <div className="rounded-lg border p-4">
            <div className='bg-[#091747] rounded-md'>
              <h3 className="font-semibold text-[12px] mb-3 bg-navy-900 text-white p-2 rounded">
                 Client Details
               </h3>
            </div>
            <div className="">
          ...
          <div className='bg-[#091747] rounded-md'>
            ...
            <div>
              ...
              <div className="ml-3 mt-1 text-[12px]">
                ...
                <div className='text-[10px] bg-green-500 max-w-fit text-white px-2 py-1 rounded-md'>
