...
const ClientCard = () => {
  ...
  const staffUsers: StaffType[] = (data || []).filter((user: StaffType) => user.userRoles === "Client");
  const ActiveUsers: StaffType[] = (data || []).filter((user: StaffType) => user.loginStatus === "Active" && user.userRoles === "Client");
  const InactiveUsers: StaffType[] = (data || []).filter((user: StaffType) => user.loginStatus === "Inactive" && user.userRoles === "Client");
