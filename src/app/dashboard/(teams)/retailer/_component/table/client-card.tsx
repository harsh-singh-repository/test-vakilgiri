...
const ClientCard = () => {
  ...
  const staffUsers: StaffType[] = (data || []).filter((user: StaffType) => user.userRoles === "Retailer");
  const ActiveUsers: StaffType[] = (data || []).filter((user: StaffType) => user.loginStatus === "Active" && user.userRoles === "Retailer");
  const InactiveUsers: StaffType[] = (data || []).filter((user: StaffType) => user.loginStatus === "Inactive" && user.userRoles === "Retailer");
